...
if (isset($_POST['tambah_presensi'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Presensi berhasil ditambahkan!'); window.location.href='hasil_data_presensi.php';</script>";
    } else {
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="input_presensi_guru.php">
        ...
        <div class="text-center">
            ...
            <a href="input_presensi_guru.php" class="btn btn-secondary w-100 mt-2">Batal</a>
        </div>
