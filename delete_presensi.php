...
if (isset($_GET['id_jadwal'])) {
    ...
    try {
        ...
        $conn->commit();
        echo "<script>alert('Data presensi berhasil dihapus!'); window.location.href='hasil_data_presensi.php';</script>";
    ...
    echo "<script>alert('ID Jadwal tidak ditemukan!'); window.location.href='hasil_data_presensi.php';</script>";
}
?>
