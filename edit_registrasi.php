...
if (isset($_POST['update'])) {
    ...
    try {
        ...
        SET id_murid = ?, tgl_reg = ?, nama = ?, tanggal_lahir = ?, alamat = ?, kelas = ?, asal_sekolah = ?, jenis_kelamin = ?, no_telp = ?, id_paket = ? 
        WHERE no_reg = ?";
        ...
        $stmt_registrasi->bind_param("sssssssssss", $id_murid, $tgl_reg, $nama, $tanggal_lahir, $alamat, $kelas, $asal_sekolah, $jenis_kelamin, $no_telp, $id_paket, $no_reg);
        ...
        SET nama = ?, tanggal_lahir = ?, alamat = ?, kelas = ?, asal_sekolah = ?, jenis_kelamin = ?, no_telp = ? 
        WHERE id_murid = ?";
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        <div class="card p-5 mb-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="id_murid" value="<?= htmlspecialchars($murid['id_murid'] ?? '') ?>" required>
            </div>
