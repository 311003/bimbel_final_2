            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <header id="header" class="header fixed-top d-flex align-items-center">
                ...
                <div class="text-center mt-3">
                    <p>Silakan isi formulir berikut untuk mendaftar sebagai guru baru.</p>
                    <a href="registrasi_guru_public.php" class="btn btn-outline-primary">Daftar Sebagai Guru Baru</a>
                </div>

                <!-- Link ke form registrasi murid -->
                    <div class="text-center mt-3">
                        <p>Silakan isi formulir berikut untuk mendaftar sebagai murid baru.</p>
                        <a href="registrasi_murid_public.php" class="btn btn-outline-primary">Daftar Sebagai Murid Baru</a>
                    </div>
