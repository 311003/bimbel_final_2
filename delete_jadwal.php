...
if (isset($_GET['id_jadwal'])) {
    ...
    try {
        ...
        $query_check = "SELECT id_jadwal FROM jadwal WHERE id_jadwal = ?";
        ...
        $query_delete = "DELETE FROM jadwal WHERE id_jadwal = ?";
        ...
        $conn->commit();
        echo "<script>alert('Data jadwal berhasil dihapus!'); window.location.href='hasil_data_jadwal.php';</script>";
    ...
    echo "<script>alert('ID Jadwal tidak ditemukan!'); window.location.href='hasil_data_jadwal.php';</script>";
}
?>
